            ...
            <div>
              <form className="needs-validation" onSubmit={formik.handleSubmit}>
                ...
                <div className="form-floating mb-3">
                  ...
                  <input name="username" autoComplete="username" required placeholder="Ваш ник" id="username" className={formik.touched.username && formik.errors.username ? "form-control is-invalid" : "form-control"}
